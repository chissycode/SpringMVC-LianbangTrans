				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							<li class="hvr-bounce-to-bottom"><a href="c_main page.html">主页</a></li>
							<li class="hvr-bounce-to-bottom active"><a href="c_order.html" >我要下单</a></li>
							<li class="hvr-bounce-to-bottom"><a href="c_order_manage_main.html">查看我的订单</a></li>
							<li class="hvr-bounce-to-bottom"><a href="c_contact us.html">联系我们</a></li>
						</ul>
						<div class="search">
...
<h1>下单成功！
<span>请在规定时间内将包裹送至投递处！</span>
</h1>
<label>
<span>&nbsp;</span>
<input type="button" class="button_5" onClick="window.location.href='c_order.html'" value="继续下单" />
<input type="button" class="button_6" onClick="window.location.href='c_order_manage_main.html'" style="margin-left:300px;"  value="查看我的订单" />
</label>
<label>
<span>&nbsp;</span>
