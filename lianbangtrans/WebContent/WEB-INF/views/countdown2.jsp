...
<div id="js-alert-box" class="alert-box"> <svg class="alert-circle" width="234" height="234">
  ...
  <div class="alert-body">
    ...
    <a id="js-alert-btn" class="alert-btn" href="/lianbangtrans/c_login.html">立即前往登陆</a> </div>
...
function alertSet(e) {
    ...
    setInterval(function() {
        if (0 == t){
			location.href="/lianbangtrans/c_login.html";//#时间到后跳转地址
		}else {
            t -= 1,
            document.getElementById("js-sec-text").innerHTML = t;
...
<script>alertSet('SORRY登陆失败');</script>
</body>
</html>
